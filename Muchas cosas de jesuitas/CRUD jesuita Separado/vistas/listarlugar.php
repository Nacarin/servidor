<?php
    ...
    if (!empty($lugaresLista)) {
        ...
        foreach ($lugaresLista as $lugarDatos) {
            ...
            echo '<td><a href="modificarlugar.php?ip=' . $lugarDatos['ip'] . '">Modificar</a></td>';
            echo '<td><a href="borrarlugar.php?ip=' . $lugarDatos['ip'] . '&lugar=' . $lugarDatos['lugar'] . '&descripcion=' . $lugarDatos['descripcion'] . '">Borrar</a></td>';
            echo '</tr>';
        }
        echo '</table>';
    } else {
